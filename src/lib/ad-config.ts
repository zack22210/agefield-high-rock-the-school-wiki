...
const BANNER_SPECS: Record<BannerFormat, BannerConfig> = {
  ...
  "160x600": { width: 160, height: 600, htmlPath: "/ads/sidebar-160x600.html" },
  "160x300": { width: 160, height: 300, htmlPath: "/ads/sidebar-160x300.html" },
  "320x50": { width: 320, height: 50, htmlPath: "/ads/banner-320x50.html" },
};

/** Keys are embedded into public/ads HTML by scripts/sync-ad-html.mjs. */
